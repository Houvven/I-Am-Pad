...
Define a class and inherit zygisk::ModuleBase to implement the functionality of your zygisk-module.
...
Since your zygisk-module class's code runs with either Zygote's privilege in pre[XXX]Specialize,
...
If your zygisk-module require access to superuser permissions, you can create and register
...
public:
    ...
    // This method is called as soon as the zygisk-module is loaded into the target process.
...
enum Option : int {
    ...
    // When this option is set, your zygisk-module's library will be dlclose-ed after post[XXX]Specialize.
    // Be aware that after dlclose-ing your zygisk-module, all of your code will be unmapped from memory.
...
struct Api {
    ...
    // zygisk-module's companion request handler. Returns -1 if the connection attempt failed.
    int connectCompanion();

    // Get the file descriptor of the root folder of the current zygisk-module.
    //
    ...
    // Set various options for your zygisk-module.
...
// Register a class as a Zygisk zygisk-module
...
// Register a root companion request handler function for your zygisk-module
//
// The function runs in a superuser daemon process and handles a root companion request from
// your zygisk-module running in a target process. The function has to accept an integer value,
